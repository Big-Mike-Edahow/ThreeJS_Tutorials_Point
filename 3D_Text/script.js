...
const gui = new GUI()                                                       // Create a new GUI.
...
const ambientLight = new THREE.AmbientLight(0xffffff, 1)                    // Set up lighting.
...
const camera = new THREE.PerspectiveCamera(30, width / height, 0.1, 1000)   // New perspective camera.
camera.position.set(0, 0, 50)
const camFolder = gui.addFolder('Camera')
camFolder.add(camera.position, 'z').min(10).max(500).step(10)
camFolder.open()

function loadFont(url) {                                                    // Promisify font loading.
